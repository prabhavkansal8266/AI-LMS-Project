  ...
  return (
    <div className='min-h-screen bg-gray-100 px-4 py-10 flex items-center justify-center'>
      ...
      <div className='bg-white shadow-lg rounded-2xl p-8 max-w-xl w-full relative'>
        ...
        <h2 className='text-2xl font-bold mt-4 textx-gray-800'>{userData.name}</h2>
      ...
      <div className='mt-6 flex justify-center gap-4'>
        <button className='px-5 py-4 rounded bg-[black] text-white active:bg-[#4b4b4b] cursor-pointer transition' onClick={()=>navigate("/editprofile")}>
          Edit Profile
        </button>
        </div>
      </div>
